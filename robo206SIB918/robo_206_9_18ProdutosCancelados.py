...
def cancelados():
    try:
        ...
        ws = wb['Situação do Plano']#primeiro parametro 
        vProdutosCancelados = wb['Produtos Cancelados']#planilha onde os dados iram ser adicionados
                ...
                for vLinhasOrigem in ws2:#PLANILHA ORIGEM
                    ...
                    for itens in vLinhasOrigem:#PLANILHA ORIGEM
                        if (vColunaAO in vListaColunaA) or (vColunaAI in vListaColunaA):
                            ...
                            vProdutosCancelados.append(vListaLinhaInteira)#escrevendo as linhas na planilha Produtos Odontologicos
                            vListaLinhaInteira = []
                        break
        wb.save(diretorio)
